...
public class DoneLastPlayerSighting : MonoBehaviour
{
	...
	//	alarm = GameObject.FindGameObjectWithTag( UnityTags.Alarm ).GetComponent<DoneAlarmLight>();

	//	// Setup the reference to the main directional light in the scene.
	//	mainLight = GameObject.FindGameObjectWithTag( UnityTags.MainLight ).light;
	...
	//	GameObject[] sirenGameObjects = GameObject.FindGameObjectsWithTag( UnityTags.Siren );
