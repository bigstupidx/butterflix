...
namespace Prime31
{
	...
	public class EtceteraBinding
	{
		...
		[DllImport("__Internal")]
		private static extern string _etceteraGetCurrentLocale();

		// Returns the locale currently set on the device
		public static string getCurrentLocale()
		{
			if( Application.platform == RuntimePlatform.IPhonePlayer )
				return _etceteraGetCurrentLocale();
			return "en_GB";
		}
	...
	#if UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_5_0 || UNITY_5_1 || UNITY_5_3_OR_NEWER
