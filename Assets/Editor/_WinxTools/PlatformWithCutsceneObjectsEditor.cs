...
[CustomEditor( typeof( PlatformWithCutsceneObjects ) )]
public class PlatformWithCutsceneObjectsEditor : Editor
{
	private PlatformWithCutsceneObjects _myTarget;
	...
	private SerializedProperty _cutsceneObjects;
	...
	void OnEnable()
	{
		...
		_myTarget = (PlatformWithCutsceneObjects)target;
		...
		_cutsceneObjects = _serializedTarget.FindProperty( "_cutsceneObjects" );
	...
	public override void OnInspectorGUI()
	{
		...
		// Extra cutscene object
		EditorGUILayout.Space();
		EditorGUILayout.PropertyField( _cutsceneObjects, new GUIContent( "Extra Cutscene Objects" ), true );
